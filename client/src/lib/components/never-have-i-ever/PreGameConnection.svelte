<script lang="ts">
	...
	let { connection = Status.DISCONNECTED, players = [] }: Props = $props();
</script>
...
>
	...
	{:else if connection === Status.DISCONNECTED}
		<p class="dark:text-red-400 text-red-700">Disconnected</p>
	{:else}
		<p class="dark:text-gray-400 text-gray-700">Connecting...</p>
	{/if}
</div>

...
test.describe('Multiplayer Events Handling', () => {
	...
	test.describe('Game State Events', () => {
		...
		test('should handle game_state synchronization across multiple players', async ({
			browser
		}) => {
			const context1 = await browser.newContext();
			const context2 = await browser.newContext();
	...
	test.describe('Concurrent Operations', () => {
		test('should handle multiple players performing actions simultaneously', async ({
			browser
		}) => {
			const context1 = await browser.newContext();
			const context2 = await browser.newContext();
